...
def run_test(implementation="gather", row_major=True, N=4, M=5):
    ...
    sdfg = create_gather_sdfg(dace.float32, in_shape, in_shape, row_major, implementation, sdfg_name)
