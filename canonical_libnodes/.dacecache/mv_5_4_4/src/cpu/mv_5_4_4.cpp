...
void __program_mv_5_4_4_internal(mv_5_4_4_t *__state, float * __restrict__ A, float * __restrict__ B, float * __restrict__ C, float * __restrict__ D)
{

    {
        float _tmp[20]  DACE_ALIGN(64);
...
DACE_EXPORTED void __program_mv_5_4_4(mv_5_4_4_t *__state, float * __restrict__ A, float * __restrict__ B, float * __restrict__ C, float * __restrict__ D)
{
    __program_mv_5_4_4_internal(__state, A, B, C, D);
}

DACE_EXPORTED mv_5_4_4_t *__dace_init_mv_5_4_4()
{
    int __result = 0;
    mv_5_4_4_t *__state = new mv_5_4_4_t;
...
DACE_EXPORTED void __dace_exit_mv_5_4_4(mv_5_4_4_t *__state)
{
    delete __state;
}
