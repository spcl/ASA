#include <cstdlib>
#include "../include/op_col_5_4_4.h"

int main(int argc, char **argv) {
    op_col_5_4_4Handle_t handle;
    ...
    handle = __dace_init_op_col_5_4_4();
    __program_op_col_5_4_4(handle, A, B, C, D);
    __dace_exit_op_col_5_4_4(handle);
